...
namespace FTN.Common
{
    ...
    public enum ModelCode : long
    {
        ...
        SEASON = 0x1500000000070000,
        SEASON_EDATE = 0x1500000000020104,
        SEASON_SDATE = 0x1500000000020204,
        SEASON_SDTS = 0x1500000000020319,

        REGUCONTROL = 0x1110000000050000,
        REGUCONTROL_DISCRETE = 0x1110000000050101,
        REGUCONTROL_MODE = 0x111000000005020a,
        REGUCONTROL_MONPHASE = 0x111000000005030a,
        REGUCONTROL_TARRANGE = 0x1110000000050405,
        REGUCONTROL_TARVAL = 0x1110000000050505,
        REGUCONTROL_REGSCHEDULE = 0x1110000000050619,
        ...
        BREAKER_INTRT = 0x1121111000070107,
        ...
        SWITCHSCH = 0x1211100000060000,
        SWITCHSCH_SWITCH = 0x1211100000060109,
